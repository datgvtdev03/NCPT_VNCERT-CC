<footer style="width: 90%; margin: auto;" class="container-fluid py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-3 ">
                    <div class="logo-part">
                        <img src="../../src/images copy/logo.png" class="w-75 logo-footer"
                ...
                <div class="col-md-7 px-4" style="line-height: 25px;">
                    ...
                    <span class="create"><img src="../../src/images copy/phone-call.png" /> Hotline:</span><br>
                    ...
                    <span class="create"><img src="../../src/images copy/mail.png" /> Email:</span><br>
                    <p class="contact-info">office@vncert.vn</p>
                    <span class="create"><img src="../../src/images copy/maps-and-flags.png" /> Địa chỉ:</span>
