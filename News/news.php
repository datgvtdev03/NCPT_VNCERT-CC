...
<body style="width: 90%;">
    ...
    <div id="banner" class="container d-flex">
        <img class="banner" style="width: 640px;" src="img/banner1.png" alt="">
        <img class="banner" style="width: 640px;" src="img/banner2.webp" alt="">
    </div>
