      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <div class="single_page_content"> <img class="img-center" style="width:85%; height:300px" src="core/upload/carousel/<?php echo $img; ?>" alt="">
            ...
            <?php
              ...
              if($relted_post){
                while ( $relted_post_row = mysqli_fetch_assoc($relted_post) ){
                  ...
                  ?>
                <li>
                  <div class="media"> <a class="media-left" href="read-post.php?id=<?php echo $related_id; ?>"> <img src="core/upload/thumbnail/<?php echo $thumb; ?>" > </a>
